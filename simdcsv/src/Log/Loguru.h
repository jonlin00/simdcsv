...
#if LOGURU_USE_FMTLIB
LOGURU_EXPORT
Text vtextprintf(const char* format, Wikinger::fmt::format_args args);

template<typename... Args>
LOGURU_EXPORT
Text textprintf(LOGURU_FORMAT_STRING_TYPE format, const Args&... args) {
  return vtextprintf(format, Wikinger::fmt::make_format_args(args...));
}
#else
LOGURU_EXPORT
...
#if LOGURU_USE_FMTLIB
  // Internal functions
void vlog(Verbosity verbosity, const char* file, unsigned line, LOGURU_FORMAT_STRING_TYPE format, Wikinger::fmt::format_args args);
void raw_vlog(Verbosity verbosity, const char* file, unsigned line, LOGURU_FORMAT_STRING_TYPE format, Wikinger::fmt::format_args args);
...
void log(Verbosity verbosity, const char* file, unsigned line, LOGURU_FORMAT_STRING_TYPE format, const Args&... args) {
  vlog(verbosity, file, line, format, Wikinger::fmt::make_format_args(args...));
}
...
void raw_log(Verbosity verbosity, const char* file, unsigned line, LOGURU_FORMAT_STRING_TYPE format, const Args&... args) {
  raw_vlog(verbosity, file, line, format, Wikinger::fmt::make_format_args(args...));
}
...
#if LOGURU_USE_FMTLIB
LOGURU_EXPORT
LOGURU_NORETURN void vlog_and_abort(int stack_trace_skip, const char* expr, const char* file, unsigned line, LOGURU_FORMAT_STRING_TYPE format, Wikinger::fmt::format_args);
template <typename... Args>
LOGURU_EXPORT
LOGURU_NORETURN void log_and_abort(int stack_trace_skip, const char* expr, const char* file, unsigned line, LOGURU_FORMAT_STRING_TYPE format, const Args&... args) {
  vlog_and_abort(stack_trace_skip, expr, file, line, format, Wikinger::fmt::make_format_args(args...));
}
#else
LOGURU_EXPORT
